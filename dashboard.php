...
// Set Cookie Section start
$cookie_name = "user";
setcookie($cookie_name, $name, time() + (86400 * 30), "/");
// Set Cookie Section ends
   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-6 image">
            <img src="images/about-img1.jpg" class="w-100 mb-5 mb-md-0" alt="">
         </div>
...
<section class="footer">
   ...
   <div class="box-container container">
      ...
      <div class="box">
         ...
         <h3>our address</h3>
         <p>Sub-Gulberg, Faisalabad, Pakistan - 38000</p>
      </div>
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>mataha386@gmail.com</p>
         <p>sobijutt@gmail.com</p>
      </div>

   </div>

   <div class="credit"> &copy; copyright @ <?php echo date('Y'); ?> by <span>Taha Sobi Web Designer</span>  </div>
